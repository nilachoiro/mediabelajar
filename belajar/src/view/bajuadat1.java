 ...
 * @author acer
 */
public class bajuadat1 extends javax.swing.JFrame {
...
public void Musik_Play() {
        try {
            audioIn = AudioSystem.getAudioInputStream(new File("aset\\suara_propinsi\\propinsi"+set+".wav"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bajuadat1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
